# Please note, this code is for personal research function. 
# It is reference from https://github.com/koreal6803/Stocker.git
# Quandl for financial analysis, pandas and numpy for data manipulation
# fbprophet(prophet) for additive models, #pytrends for Google trend data
import pandas as pd
import numpy as np
import prophet
